...
type Repository interface {
	...
	DB() *gorm.DB
	Get(ctx context.Context, opts ...FilterOption) (*entrymodel.CryptoMaterialEntry, error)
...
func (r *repository) Get(ctx context.Context, opts ...FilterOption) (*entrymodel.CryptoMaterialEntry, error) {
	return r.get(ctx, newFilter(opts...))
}

func (r *repository) List(ctx context.Context, opts ...FilterOption) ([]*entrymodel.CryptoMaterialEntry, string, error) {
	return r.list(ctx, newFilter(opts...))
}

func (r *repository) UnpaginatedList(ctx context.Context, opts ...FilterOption) ([]*entrymodel.CryptoMaterialEntry, error) {
