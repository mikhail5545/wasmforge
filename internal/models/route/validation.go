...
func (req ListRequest) Validate() error {
	return validation.ValidateStruct(&req,
		...
		validation.Field(&req.AppIDs, validation.Each(is.UUID)),
...
func (req CreateRequest) Validate() error {
	return validation.ValidateStruct(&req,
		...
		validation.Field(&req.TargetURL, validation.When(req.AppID == nil || *req.AppID == "", validation.Required), is.URL),
		validation.Field(&req.AppID, validation.When(req.TargetURL == "", validation.Required), is.UUID),
...
func (req UpdateRequest) Validate() error {
	return validation.ValidateStruct(&req,
		...
		validation.Field(&req.AppID, validation.NilOrNotEmpty, is.UUID),
