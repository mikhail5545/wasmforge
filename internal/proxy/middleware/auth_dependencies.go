...
type ConfigRepository = configrepo.Repository
type TokenValidator = authsvc.TokenValidator
type TokenIssuer = authsvc.TokenIssuer
type AuditRepository = auditrepo.Repository
